      ...
      <div id="paneHard" class="task-pane active">
        <div class="glass section-card">
          ...
          <div class="card-desc">
            ...
            Переходи по ссылке, выполняй условия и получай TON на баланс.
          </div>
          ...
          <div class="task-note">
            <strong style="color:var(--text-mid);">Важно:</strong> нажми кнопку — перейдёшь в список заданий. Подписывайся на каналы или переходи на сайты прямо оттуда. Только тогда выполнение засчитывается.
          </div>
        </div>
      </div>
